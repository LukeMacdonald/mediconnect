...
class _BookingByTime extends State<BookingByTime> {
  ...
  Future getAvailability() async {
    final response = await http.get(Uri.parse("${availabilityIP}get/all/availabilities"),
        headers: {
    ...
    for (var availability in responseData) {
      ...
      final responseName = await http.get(Uri.parse("${authenticationIP}user/get/name/$doctorId"),
          headers: {
            'Content-Type': 'application/json',
            HttpHeaders.authorizationHeader:user.accessToken
          }
  ...
  Future checkAppointment(int id, String date, String startTime) async {
    final response = await http.get(Uri.parse("${appointmentIP}search/appointment/$id/$date/$startTime"),
        headers: {
          'Content-Type': 'application/json',
           HttpHeaders.authorizationHeader:user.accessToken
        }
